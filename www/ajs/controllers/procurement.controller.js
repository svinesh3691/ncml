            ...
            $scope.fields = [
                 {
                     ...
                     options: [
                         {
                             title: 'Amirta Agencies',
                             value: '1'
                         },
                         {
                             title: 'Mithuna Agencies',
                             value: '2'
                         },
                         {
                             title: 'Sparklight Agencies',
                             value: '3'
                         },
                         {
                             title: 'Make India Agencies',
                             value: '4'
                         }
                     ]
                 },
    ...
    function ( $scope , fns , seven , $state) {
            ...
            $scope.save = function(data){
                ...
                fns.query('INSERT into Procurement (JsonContent,ServerId) VALUES (?,?)',[JSON.stringify(data),0],function(res){
                    var lastInsertId = res.result.insertId;
                    fns.query('INSERT into Test (ProcurementId,Damaged,DisColoured,ChalkyGrain,RedGrains,AdMixtures,DeHusked,Moisture) VALUES (?,?,?,?,?,?,?,?)',[lastInsertId,0,0,0,0,0,0,0],function(res){
                            seven.hidePreloader();
